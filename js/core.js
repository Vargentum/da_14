 ...
 */
$(function(){
    $('.js-index__carousel').carouFredSel({
        transition: 'ease',
        scroll: 1,
        prev: '.b-index__carousel__control--prev',
        next: '.b-index__carousel__control--next',
        swipe: {
            onMouse: true,
            onTouch: true
        }
    });
    $('.b-team__unit').each(function(){
        var $label = $(this).find('.b-team__unit__hoverLabel');
